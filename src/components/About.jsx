  ...
  return (
    ...
    >
      <div className="about-container max-w-[1240px] my-8  mx-auto sm:flex flex-col sm:w-screen justify-center items-center align-center">
        <motion.h2
          className="title text-blue-200  font-extrabold text-xl uppercase tracking-widest text-center"
          initial={{ opacity: 0 }}
        ...
        <div className="sm:m-[1rem] ">
          ...
          >
            <p>
              ...
              Additionally, I utilise Git (specifically GitHub), JavaScript,
              ReactJS, NextJS, and other related technologies. I am constantly
              seeking ways to fulfill business requirements and enhance user
              experiences by enhancing the visual appeal, responsiveness, and
              accessibility of websites and web applications.
              <br />
              <br />
              As a team-player who believes in achieving more with focus-minded
              team-members. I possess good communication skills, the ability to
              collaborate, a positive attitude and overall good work ethics.
              <br />
              <Link
                href={"/#contact"}
